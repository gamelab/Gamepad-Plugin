...
* @param parent {}
* @param axesThreshold {Number} - optional - inbetween 0 - 1. This sets the threshold that a thumbstick must exceed before it is considered hit.
* @param triggerThreshold {Number} - optional - inbetween 0 - 1. This sets the threshold that a button must exceed before it is considered hit.
*/
...
/*
* This method creates all of the axes that a Controller will use and assigns names.
* @method createAxes
* @private
*/
...
/*
* This method checks to see if the state of a button has changed and fire the appropriate signal
* @method checkButtons
* @private
*/
...
/*
* This method checks to see if the state of a axes has changed and fire the appropriate signal
* @method checkButtons
* @private
*/
...
* @param index {Number} This is the index of the button mapped out on the controller. 
* @param name {String} The name that we give the button. We have based these off the Xbox 360 controller
* @param threshold {Number} - optional - inbetween 0 - 1. This sets the threshold that a button must exceed before it is considered hit. Only works for triggers.
*/
